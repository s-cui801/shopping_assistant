...
# Define the tools that the assistant can use as safe and sensitive tools
safe_tools = [
...
# Define the assistant runnable which is a combination of the primary assistant prompt and the tools
assistant_runnable = primary_assistant_prompt | llm.bind_tools(safe_tools + sensitive_tools)

# Create the graph
builder = StateGraph(State)

# Define nodes: these are the functions that will be called
